      ...
      <li class="relative px-6 py-3" x-data="{ isMenu2Open: true }">
        ...
        <template x-if="isMenu2Open">
          <ul x-transition:enter="transition-all ease-in-out duration-300" x-transition:enter-start="opacity-25 max-h-0"
            ...
            <li class="mt-1 px-2 py-1 transition-colors duration-150 text-deep-purple">
              <span class="inline-flex items-center font-bold justify-between w-full hover:text-deep-purple">
                <svg class="w-2.5 h-2.5 text-yellow-orange" viewBox="0 0 11 11" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <ellipse cx="5.456" cy="5.5" rx="4.09174" ry="4.125" fill="currentColor" />
...
@section('content')
  <div class=" p-10 flex items-center justify-center font-poppins">
    <div class="container max-w-screen-lg mx-auto">
      <div>
        <h2 class="font-semibold text-xl text-blue-gray">Tambah Kesenian & Alat Olahraga</h2>
        <p class="text-gray-500 mb-6 text-sm">Form untuk menambahkan kontent</p>

        <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">


          <div class="lg:col-span-2 m-3">
            <div class="grid gap-4 gap-y-3 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5 mb-5">
                <label for="full_name" class="font-medium after:content-['*'] after:text-red-500 ">Nama Kesenian & Alat
                  Olahraga</label>
                <input type="text" name="full_name" id="full_name"
                  class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" />
                <p class="text-xs mt-2 text-[#858584]">Tuliskan nama kesenian dan alat olahraga</p>
              </div>
              <div class="md:col-span-2 mb-5">
                ...
                <p class="text-xs mt-2 text-[#858584]">Pilih kategori kesenian dan olahraga</p>
              </div>

              <div class="md:col-span-3 mb-5">
                <label for="small-thumbnail" class="font-medium after:content-['*'] after:text-red-500 ">Small
                  Thumbnail</label>
                <input type="file" name="small-thumbnail" id="small-thumbnail"
                  class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                <p class="text-xs mt-2 text-[#858584]">Pilih foto untuk dijadikan thumbnail</p>
              </div>
              ...
              <div class="md:col-span-5 mb-5">
                ...
                <p class="text-xs mt-2 text-[#858584]">Tuliskan tentang kesenian dan alat olahraga</p>
              </div>

              <div class="md:col-span-5 mb-5">
                <label for="image-detail-1" class="font-medium after:content-['*'] after:text-red-500 ">Image Detail
                  1</label>
                <input type="file" name="image-detail-1" id="image-detail-1"
                  class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                <p class="text-xs mt-2 text-[#858584]">Pilih foto untuk detail fasilitas</p>
              </div>

              <div class="md:col-span-5 mb-5">
                <label for="image-detail-2" class="font-medium after:content-['*'] after:text-red-500 ">Image Detail
                  2</label>
                <input type="file" name="image-detail-2" id="image-detail-2"
                  class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                <p class="text-xs mt-2 text-[#858584]">Pilih foto untuk detail fasilitas</p>
              </div>
              ...
              <div class="md:col-span-5 mb-5">
                <label for="added-by" class="font-medium after:content-['*'] after:text-red-500 ">Ditambahkan
                  Oleh</label>
                <input type="text" name="added-by" id="added-by"
                  class="h-10 border mt-2 rounded px-4 w-full bg-gray-200 text-gray-700" value="nilai dari db"
                  readonly />
              </div>
