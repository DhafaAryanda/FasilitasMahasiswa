        ...
        <table class="table-auto w-full border-collapse bg-white text-left text-sm text-gray-500">
          ...
          <tbody class="divide-y divide-gray-100 border-t border-gray-100">
            <tr class="hover:bg-gray-50">
              <td class="px-6 py-4">Lapangan Basket Indoor</td>
              <td class="px-2 py-3 h-28 w-auto">
                <img
                    class="h-full w-full rounded-md object-cover object-center"
                    src="https://asset.kompas.com/crops/4PW3AEfzo2ujo-ITY_p90FlG7NQ=/0x0:4320x2880/750x500/data/photo/2021/10/07/615e73262e64b.jpg"
                    alt=""
                  />  
              </td>
              <td class="px-6 py-4">Lapangan Indoor</td>
