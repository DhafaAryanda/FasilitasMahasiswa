    ...
    <div class="container max-w-screen-lg mx-auto">
      ...
      <div>
        ...
        <form class="mb-20" enctype="multipart/form-data"
          action="{{ route('admin.manajemen.create.transaction.confirm.store', $facility->id) }}" method="POST"
          id="facilityForm">
          @csrf
          ...
          <div class="flex flex-col lg:flex-row md:gap-5 xl:gap-10 lg:mx-5 xl:mx-10 my-5">
              ...
              <div class="flex">
                <div class="my-5 mx-6 sm:mx-12 lg:mx-10 xl:mx-12 text-sm flex flex-col gap-6">
                  ...
                  <div class="md:col-span-5">
                    ...
                    <p class=" mt-2 text-[#858584]">{{ session('transaction-facility-data.guest_name') }}
                    </p>
                  </div>
                  <div class="md:col-span-5">
            ...
            <section class="flex-1 bg-white rounded-lg border border-gray-200 shadow-md mb-3">
              ...
              <hr>
              <div class="mt-5 mb-6 mx-6 sm:mx-12 lg:mx-6 xl:mx-12 text-sm flex flex-col gap-3 ">
                <div class="flex font-medium">
                  <label for="title" class="flex-1">Total</label>
                  <p class="">Rp. {{ number_format($transaction['amount'], 2, ',', '.') }}</p>
                </div>
              </div>
              <div class=" mb-12 mx-6 sm:mx-12 lg:mx-6 xl:mx-12 text-sm flex flex-col gap-3">
                <label for="amount" class="flex-1 font-medium">Ubah Total Biaya (opsional)</label>
                <input type="text" name="amount" id="amount" class="h-10 border rounded px-4 w-full bg-gray-50"
                  value="{{ session('transaction-facility-data.amount') }}" />
                <p class="text-xs text-[#858584]">Tuliskan total biaya hanya jika ingin harga berubah</p>
              </div>
