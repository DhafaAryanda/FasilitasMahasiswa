      ...
      <div class="flex flex-row mt-5 mb-10">
        ...
        <div class="flex-1 flex-col">
          ...
          <ul class="mt-5">
            ...
            <a href="#" class="text-sm font-medium text-blue-500 underline">Lihat Bukti Transfer</a>
          </ul>
        ...
        <div class="flex-1 flex-col">
          ...
          <form class="confirmation-form"
            ...
            <div class="flex justify-end m-5 gap-4 text-sm">
              <button type="submit" name="action" value="reject"
                class="w-24 h-auto bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded">Tolak</button>
          ...
          <div class="flex justify-end">
            <form action="{{ route('admin.manajemen.sewa.facility.confirm', $transaction->id) }}" method="POST">
              ...
              <button type="submit" name="action" value="confirm"
                class="w-24 h-auto bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded">Terima</button>
            </form>
          </div>
        </div>
