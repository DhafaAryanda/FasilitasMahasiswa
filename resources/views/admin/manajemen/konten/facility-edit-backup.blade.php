          ...
          <div class="lg:col-span-2 m-3 p-4 px-4 md:p-8 mb-6">            
            <div class="grid gap-4 gap-y-3 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5 mb-5">
                ...
                <input type="text" name="title" id="title" class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="{{ $facility->title }}"/>
              ...
              <div class="md:col-span-5 mb-5">
                ...
                <textarea type="text" name="about" id="about" class="h-24 border mt-2 rounded px-4 w-full bg-gray-50" placeholder="" >{{ $facility->about }}</textarea>
              ...
              <div class="md:col-span-5 mb-5">
                ...
                <input type="file" name="image2_detail" id="image2_detail" class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                <p class="text-xs mt-2 text-[#858584]">Pilih foto untuk detail fasilitas</p>
              </div>

              <div class="md:col-span-5 mb-5">
                <label for="image3_detail" class="font-medium ">Image Detail 3</label>
                <input type="file" name="image3_detail" id="image3_detail" class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                <p class="text-xs mt-2 text-[#858584]">Pilih foto untuk detail fasilitas</p>
              </div>

              <div class="md:col-span-5 mb-5">
                <label for="image4_detail" class="font-medium">Image Detail 4</label>
                <input type="file" name="image4_detail" id="image4_detail" class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                <p class="text-xs mt-2 text-[#858584]">Pilih foto untuk detail fasilitas</p>
              </div>
