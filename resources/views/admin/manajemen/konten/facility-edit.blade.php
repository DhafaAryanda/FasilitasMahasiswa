          ...
          <form enctype="multipart/form-data" action="{{ route('admin.manajemen.konten.facility.update', $facility->id) }}"
            ...
            <div class="md:col-span-5 text-right">
              <div class="flex items-end">
                <a href="{{ route('admin.manajemen.konten.facility.destroy', $facility->id) }} id="deleteButton"
                  class="bg-red-500 mx-2 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
