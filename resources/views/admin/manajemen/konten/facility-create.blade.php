              ...
              <div class="flex py-3 mx-2">
                ...
                <div class="flex items-center">
                  <div class="flex w-[600px]">
                    <input type="text" name="title" id="title" class="h-10 border mt-2 rounded px-4 w-full text-sm bg-gray-50" value="{{ old('title') }}"/>
                  </div>
                </div>     
              </div>
              <div class="flex py-3 mx-2">
          ...
          <div class="bg-white rounded-lg border border-gray-200 shadow-md mb-3">
            ...
            <div class="mt-4 mb-4 mx-10 ">            
              ...
              <div class="flex py-6 mx-2">
                ...
                <textarea type="text" name="about" id="about" class="text-sm h-64 w-[600px] border  mt-2 rounded-md  bg-gray-50 " placeholder="" >{{ old('about')}}</textarea>
              ...
              <div class="flex py-3 mx-2">
                ...
                <div class="flex items-center">
                  <div class="flex w-[600px]">
                    ...
                    <input type="text" id="price_per_hour" name="price_per_hour" class="rounded-none rounded-r-md bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 " placeholder="misal: 250000" value="{{ old('price_per_hour') }}">
                  </div>
                </div>     
              </div>
            </div>
              ...
              <div class="flex py-3 mx-2">
                ...
                <div class="flex items-center">
                  <div class="flex w-[600px]">
                    ...
                    <input type="text" id="price_per_day" name="price_per_day" class="rounded-none rounded-r-md bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 " placeholder="misal: 2000000" value="{{ old('price_per_day') }}">
                  </div>
                </div>     
              </div>
            </div>
