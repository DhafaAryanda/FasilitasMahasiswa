              ...
              <div class="flex">
                ...
                <div class="flex-1 mx-5">
                  ...
                  <div class="mt-4 mb-4 mx-5 text-sm">
                    ...
                    <div class="md:col-span-5 mb-5">
                      <label for="title" class="font-medium after:content-['*'] after:text-red-500 ">Jadwal Kegiatan
                        Berlangsung</label>
                      <input type="text" name="title" id="title"
                        class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" {{-- value="{{ $facility->title }}" --}} />
                    ...
                    <div class="md:col-span-5 mb-5">
                      <label for="title" class="font-medium after:content-['*'] after:text-red-500 ">Durasi
                        Kegiatan</label>
                      <input type="text" name="title" id="title"
                        class="h-10 border mt-2 rounded px-4 w-full bg-gray-50" {{-- value="{{ $facility->title }}" --}} />
