  ...
  <div class=" m-10 flex items-center justify-center font-poppins">
    <div class="container max-w-screen-lg mx-auto">
      <div class="flex flex-col">
        ...
        <div class="bg-white rounded-lg  h-72 w-full relative mb-8">
          ...
          <h2 class="w-2/5 mx-20 flex font-semibold text-2xl absolute inset-y-0 items-center justify-center">
